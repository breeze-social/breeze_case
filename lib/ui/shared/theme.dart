...
class BreezeTheme {
  ...
  static ThemeData themeData = ThemeData(
      ...
      textTheme: TextTheme(
          ...
          headline3: GoogleFonts.dmSans(fontSize: 18, fontWeight: FontWeight.w700, color: kDarkBlue),
          headline4: GoogleFonts.dmSans(fontSize: 16, fontWeight: FontWeight.w700, color: kDarkBlue),
          headline5: GoogleFonts.dmSans(fontSize: 14, fontWeight: FontWeight.w700, color: kDarkBlue),
          headline6: GoogleFonts.dmSans(fontSize: 12, fontWeight: FontWeight.w700, color: kDarkBlue),
