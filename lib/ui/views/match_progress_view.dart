...
import 'package:breeze_case/ui/view_models/match_progress_view_model.dart';
import 'package:breeze_case/ui/widgets/match_card.dart';
import 'package:flutter/material.dart';
import 'package:stacked/stacked.dart';

class MatchProgressView extends StatelessWidget {
  const MatchProgressView(this.matchId, {super.key});

  final String matchId;

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<MatchProgressViewModel>.reactive(
        viewModelBuilder: () => MatchProgressViewModel(matchId),
